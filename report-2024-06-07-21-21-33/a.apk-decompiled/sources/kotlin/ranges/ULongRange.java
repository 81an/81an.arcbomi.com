...
public final class ULongRange extends ULongProgression implements ClosedRange<ULong>, OpenEndRange<ULong> {
    ...
    public static /* synthetic */ void m1658getEndExclusivesVKNKU$annotations() {
    }

    @Override // kotlin.ranges.ClosedRange, kotlin.ranges.OpenEndRange
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m1659containsVKZWuLQ(((ULong) comparable).getData());
    }

    @Override // kotlin.ranges.OpenEndRange
    public /* bridge */ /* synthetic */ ULong getEndExclusive() {
        return ULong.m582boximpl(m1660getEndExclusivesVKNKU());
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ ULong getEndInclusive() {
        return ULong.m582boximpl(m1661getEndInclusivesVKNKU());
    }

    @Override // kotlin.ranges.ClosedRange, kotlin.ranges.OpenEndRange
    public /* bridge */ /* synthetic */ Comparable getStart() {
        return ULong.m582boximpl(m1662getStartsVKNKU());
    }
    ...
    public long m1662getStartsVKNKU() {
        return getFirst();
    }

    /* renamed from: getEndInclusive-s-VKNKU, reason: not valid java name */
    public long m1661getEndInclusivesVKNKU() {
        return getLast();
    }

    /* renamed from: getEndExclusive-s-VKNKU, reason: not valid java name */
    public long m1660getEndExclusivesVKNKU() {
        if (getLast() == -1) {
            throw new IllegalStateException("Cannot return the exclusive upper bound of a range that includes MAX_VALUE.".toString());
        }
        return ULong.m588constructorimpl(getLast() + ULong.m588constructorimpl(1 & KeyboardMap.kValueMask));
    }

    /* renamed from: contains-VKZWuLQ, reason: not valid java name */
    public boolean m1659containsVKZWuLQ(long value) {
    ...
    public int hashCode() {
        ...
        return ((int) ULong.m588constructorimpl(getLast() ^ ULong.m588constructorimpl(getLast() >>> 32))) + (((int) ULong.m588constructorimpl(getFirst() ^ ULong.m588constructorimpl(getFirst() >>> 32))) * 31);
    }

    @Override // kotlin.ranges.ULongProgression
    public String toString() {
        return ((Object) ULong.m633toStringimpl(getFirst())) + ".." + ((Object) ULong.m633toStringimpl(getLast()));
    }
