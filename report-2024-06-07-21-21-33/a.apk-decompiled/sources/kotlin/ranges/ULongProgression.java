...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m1630getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int m588constructorimpl = ((int) ULong.m588constructorimpl(j ^ ULong.m588constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int m588constructorimpl2 = (m588constructorimpl + ((int) ULong.m588constructorimpl(j2 ^ ULong.m588constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + m588constructorimpl2;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) ULong.m633toStringimpl(this.first));
            sb.append("..");
            sb.append((Object) ULong.m633toStringimpl(this.last));
            sb.append(" step ");
            j = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1656fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
