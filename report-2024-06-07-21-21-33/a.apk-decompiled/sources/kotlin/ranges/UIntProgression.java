...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    private UIntProgression(int i, int i2, int i3) {
        ...
        this.first = i;
        this.last = UProgressionUtilKt.m1631getProgressionLastElementNkh28Cs(i, i2, i3);
        this.step = i3;
    }
    ...
    public static final class Companion {
        ...
        public final UIntProgression m1647fromClosedRangeNkh28Cs(int rangeStart, int rangeEnd, int step) {
