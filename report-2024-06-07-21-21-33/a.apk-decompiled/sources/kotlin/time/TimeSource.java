...
public interface TimeSource {
    ...
    public static final class Monotonic implements TimeSource {
        ...
        public /* bridge */ /* synthetic */ TimeMark markNow() {
            return ValueTimeMark.m1877boximpl(m1876markNowz9LOYto());
        }

        /* renamed from: markNow-z9LOYto, reason: not valid java name */
        public long m1876markNowz9LOYto() {
            return MonotonicTimeSource.INSTANCE.m1871markNowz9LOYto();
        }
        ...
        public static final class ValueTimeMark implements TimeMark {
            ...
            public static final /* synthetic */ ValueTimeMark m1877boximpl(long j) {
            ...
            public static String m1887toStringimpl(long j) {
            ...
            public String toString() {
                return m1887toStringimpl(this.reading);
            }
            ...
            public /* bridge */ /* synthetic */ TimeMark mo1732minusLRDsOJo(long j) {
                return m1877boximpl(m1888minusLRDsOJo(j));
            }

            @Override // kotlin.time.TimeMark
            /* renamed from: plus-LRDsOJo */
            public /* bridge */ /* synthetic */ TimeMark mo1733plusLRDsOJo(long j) {
                return m1877boximpl(m1889plusLRDsOJo(j));
            }
            ...
            public static long m1879elapsedNowUwyO8pc(long j) {
                return MonotonicTimeSource.INSTANCE.m1870elapsedFrom6eNON_k(j);
            }

            @Override // kotlin.time.TimeMark
            /* renamed from: elapsedNow-UwyO8pc */
            public long mo1731elapsedNowUwyO8pc() {
                return m1879elapsedNowUwyO8pc(this.reading);
            }

            /* renamed from: plus-LRDsOJo, reason: not valid java name */
            public static long m1886plusLRDsOJo(long j, long j2) {
                return MonotonicTimeSource.INSTANCE.m1869adjustReading6QKq23U(j, j2);
            }

            /* renamed from: plus-LRDsOJo, reason: not valid java name */
            public long m1889plusLRDsOJo(long j) {
                return m1886plusLRDsOJo(this.reading, j);
            }

            /* renamed from: minus-LRDsOJo, reason: not valid java name */
            public static long m1885minusLRDsOJo(long j, long j2) {
                return MonotonicTimeSource.INSTANCE.m1869adjustReading6QKq23U(j, Duration.m1791unaryMinusUwyO8pc(j2));
            }

            /* renamed from: minus-LRDsOJo, reason: not valid java name */
            public long m1888minusLRDsOJo(long j) {
                return m1885minusLRDsOJo(this.reading, j);
            }

            /* renamed from: hasPassedNow-impl, reason: not valid java name */
            public static boolean m1883hasPassedNowimpl(long j) {
                return !Duration.m1772isNegativeimpl(m1879elapsedNowUwyO8pc(j));
            }
