...
public interface TimeMark {
    ...
    TimeMark mo1732minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1733plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m1875plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m1874minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo1733plusLRDsOJo(Duration.m1791unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m1772isNegativeimpl(timeMark.mo1731elapsedNowUwyO8pc());
        }
