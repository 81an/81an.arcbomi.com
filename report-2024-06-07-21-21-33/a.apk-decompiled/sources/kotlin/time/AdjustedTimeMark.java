...
final class AdjustedTimeMark implements TimeMark {
    ...
    public long mo1731elapsedNowUwyO8pc() {
        return Duration.m1774minusLRDsOJo(this.mark.mo1731elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1733plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1775plusLRDsOJo(this.adjustment, duration), null);
    }
}
