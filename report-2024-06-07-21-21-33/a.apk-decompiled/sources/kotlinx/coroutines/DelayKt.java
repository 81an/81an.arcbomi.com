...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo1962scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m1901delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1902toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1902toDelayMillisLRDsOJo(long j) {
        if (Duration.m1738compareToLRDsOJo(j, Duration.INSTANCE.m1841getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1757getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
