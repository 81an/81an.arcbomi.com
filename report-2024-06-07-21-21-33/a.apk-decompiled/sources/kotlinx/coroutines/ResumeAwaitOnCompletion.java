...
public final class ResumeAwaitOnCompletion<T> extends JobNode {
    ...
    public void invoke2(Throwable cause) {
        ...
        if (state$kotlinx_coroutines_core instanceof CompletedExceptionally) {
            ...
            cancellableContinuationImpl.resumeWith(Result.m416constructorimpl(ResultKt.createFailure(th)));
            return;
        }
        ...
        cancellableContinuationImpl2.resumeWith(Result.m416constructorimpl(unboxState));
    }
}
