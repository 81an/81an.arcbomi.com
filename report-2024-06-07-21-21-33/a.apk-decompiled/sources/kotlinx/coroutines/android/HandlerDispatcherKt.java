...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            m416constructorimpl = Result.m416constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m416constructorimpl = Result.m416constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m422isFailureimpl(m416constructorimpl) ? null : m416constructorimpl);
    }
    ...
    public static final Object awaitFrame(Continuation<? super Long> continuation) {
        ...
        Dispatchers.getMain().mo1961dispatch(EmptyCoroutineContext.INSTANCE, new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrame$lambda-3$$inlined$Runnable$1
    ...
    public static final void postFrameCallback(Choreographer choreographer2, final CancellableContinuation<? super Long> cancellableContinuation) {
        choreographer2.postFrameCallback(new Choreographer.FrameCallback() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$$ExternalSyntheticLambda0
            ...
            public final void doFrame(long j) {
                HandlerDispatcherKt.m1913postFrameCallback$lambda6(CancellableContinuation.this, j);
            }
        });
    }
    ...
    public static final void m1913postFrameCallback$lambda6(CancellableContinuation cancellableContinuation, long j) {
