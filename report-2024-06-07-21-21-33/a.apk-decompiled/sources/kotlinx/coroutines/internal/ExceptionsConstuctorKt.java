...
public final class ExceptionsConstuctorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                m416constructorimpl = Result.m416constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                m416constructorimpl = Result.m416constructorimpl(ResultKt.createFailure(th));
            }
            return (E) (Result.m422isFailureimpl(m416constructorimpl) ? null : m416constructorimpl);
        }
            ...
            return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstuctorKt$createConstructor$$inlined$safeCtor$4
                ...
                public final Throwable invoke(Throwable th) {
                    ...
                    try {
                        ...
                        Result.Companion companion2 = Result.INSTANCE;
                        m416constructorimpl = Result.m416constructorimpl(ResultKt.createFailure(th2));
                    }
                    if (newInstance != null) {
                        Throwable th3 = (Throwable) newInstance;
                        th3.initCause(th);
                        m416constructorimpl = Result.m416constructorimpl(th3);
                        if (Result.m422isFailureimpl(m416constructorimpl)) {
                            m416constructorimpl = null;
                        }
                        return (Throwable) m416constructorimpl;
                    }
            ...
            if (length == 2 && Intrinsics.areEqual(parameterTypes[0], String.class) && Intrinsics.areEqual(parameterTypes[1], Throwable.class)) {
                return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstuctorKt$createConstructor$$inlined$safeCtor$1
                    ...
                    public final Throwable invoke(Throwable th) {
                        ...
                        if (newInstance != null) {
                            m416constructorimpl = Result.m416constructorimpl((Throwable) newInstance);
                            if (Result.m422isFailureimpl(m416constructorimpl)) {
                                m416constructorimpl = null;
                            }
                            return (Throwable) m416constructorimpl;
    ...
    private static final Function1<Throwable, Throwable> safeCtor(final Function1<? super Throwable, ? extends Throwable> function1) {
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstuctorKt$safeCtor$1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    Result.Companion companion = Result.INSTANCE;
                    m416constructorimpl = Result.m416constructorimpl(function12.invoke(th));
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.INSTANCE;
                    m416constructorimpl = Result.m416constructorimpl(ResultKt.createFailure(th2));
                }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            m416constructorimpl = Result.m416constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m416constructorimpl = Result.m416constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m422isFailureimpl(m416constructorimpl)) {
            m416constructorimpl = valueOf;
        }
        return ((Number) m416constructorimpl).intValue();
    }
