    ...
    public final void run() {
        ...
        try {
            ...
            try {
                ...
                if (job != null && !job.isActive()) {
                    ...
                    if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                        ...
                        continuation.resumeWith(Result.m416constructorimpl(ResultKt.createFailure(cancellationException)));
                    }
                    cancellationException = cancellationException2;
                    continuation.resumeWith(Result.m416constructorimpl(ResultKt.createFailure(cancellationException)));
                } else if (exceptionalResult$kotlinx_coroutines_core != null) {
                    Result.Companion companion2 = Result.INSTANCE;
                    continuation.resumeWith(Result.m416constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
                } else {
                    T successfulResult$kotlinx_coroutines_core = getSuccessfulResult$kotlinx_coroutines_core(takeState$kotlinx_coroutines_core);
                    Result.Companion companion3 = Result.INSTANCE;
                    continuation.resumeWith(Result.m416constructorimpl(successfulResult$kotlinx_coroutines_core));
                }
                ...
                try {
                    ...
                    m416constructorimpl2 = Result.m416constructorimpl(Unit.INSTANCE);
                } catch (Throwable th) {
                    Result.Companion companion5 = Result.INSTANCE;
                    m416constructorimpl2 = Result.m416constructorimpl(ResultKt.createFailure(th));
                }
                handleFatalException(null, Result.m419exceptionOrNullimpl(m416constructorimpl2));
            } finally {
            ...
            try {
                ...
                taskContext.afterTask();
                m416constructorimpl = Result.m416constructorimpl(Unit.INSTANCE);
            } catch (Throwable th3) {
                Result.Companion companion7 = Result.INSTANCE;
                m416constructorimpl = Result.m416constructorimpl(ResultKt.createFailure(th3));
            }
            handleFatalException(th2, Result.m419exceptionOrNullimpl(m416constructorimpl));
        }
    }
