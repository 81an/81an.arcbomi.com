...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m416constructorimpl = Result.m416constructorimpl(property == null ? null : Boolean.valueOf(Boolean.parseBoolean(property)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m416constructorimpl = Result.m416constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m422isFailureimpl(m416constructorimpl) ? null : m416constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1939installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m1939installSignalHandler$lambda1(Signal signal) {
