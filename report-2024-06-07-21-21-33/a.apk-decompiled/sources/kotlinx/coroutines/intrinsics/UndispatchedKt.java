        ...
        try {
            if (function1 != null) {
                ...
                if (invoke != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                    ...
                    probeCoroutineCreated.resumeWith(Result.m416constructorimpl(invoke));
                    return;
                }
                return;
            }
            ...
            probeCoroutineCreated.resumeWith(Result.m416constructorimpl(ResultKt.createFailure(th)));
        }
    }
