    ...
    */
    public java.lang.Object offerInternal(E r6) {
        /*
            ...
            kotlinx.coroutines.channels.Closed r2 = r5.getClosedForSend()     // Catch: java.lang.Throwable -> L65
            if (r2 != 0) goto L61
            kotlinx.coroutines.internal.Symbol r2 = r5.updateBufferSize(r1)     // Catch: java.lang.Throwable -> L65
            if (r2 != 0) goto L5d
            if (r1 != 0) goto L54
        L17:
            kotlinx.coroutines.channels.ReceiveOrClosed r2 = r5.takeFirstReceiveOrPeekClosed()     // Catch: java.lang.Throwable -> L65
            if (r2 != 0) goto L1e
            goto L54
        L1e:
        ...
        L28:
            r3 = 0
            kotlinx.coroutines.internal.Symbol r3 = r2.tryResumeReceive(r6, r3)     // Catch: java.lang.Throwable -> L65
            if (r3 == 0) goto L17
            boolean r4 = kotlinx.coroutines.DebugKt.getASSERTIONS_ENABLED()     // Catch: java.lang.Throwable -> L65
            if (r4 == 0) goto L45
            kotlinx.coroutines.internal.Symbol r4 = kotlinx.coroutines.CancellableContinuationImplKt.RESUME_TOKEN     // Catch: java.lang.Throwable -> L65
            if (r3 != r4) goto L3b
            r3 = 1
            goto L3c
        L3b:
        ...
        L45:
            ...
            return r6
        L54:
            r5.enqueueElement(r1, r6)     // Catch: java.lang.Throwable -> L65
            kotlinx.coroutines.internal.Symbol r6 = kotlinx.coroutines.channels.AbstractChannelKt.OFFER_SUCCESS     // Catch: java.lang.Throwable -> L65
            r0.unlock()
            return r6
        L5d:
            r0.unlock()
    ...
    */
    protected java.lang.Object pollSelectInternal(kotlinx.coroutines.selects.SelectInstance<?> r9) {
        ...
        L2b:
            ...
            java.lang.Object r2 = r2.getElement()     // Catch: java.lang.Throwable -> Lc1
        L46:
            r3 = 1
            goto L7e
        L48:
