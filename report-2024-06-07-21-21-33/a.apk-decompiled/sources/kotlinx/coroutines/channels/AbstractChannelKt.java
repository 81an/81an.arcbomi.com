...
public final class AbstractChannelKt {
    ...
    private static final <E> Object toResult(Object obj) {
        return obj instanceof Closed ? ChannelResult.INSTANCE.m1935closedJP2dKIU(((Closed) obj).closeCause) : ChannelResult.INSTANCE.m1937successJP2dKIU(obj);
    }

    private static final <E> Object toResult(Closed<?> closed) {
        return ChannelResult.INSTANCE.m1935closedJP2dKIU(closed.closeCause);
    }
}
