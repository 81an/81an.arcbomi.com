...
public interface SendChannel<E> {
    ...
    Object mo1917trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo1917trySendJP2dKIU = sendChannel.mo1917trySendJP2dKIU(e);
            if (ChannelResult.m1932isSuccessimpl(mo1917trySendJP2dKIU)) {
                return true;
            }
            Throwable m1926exceptionOrNullimpl = ChannelResult.m1926exceptionOrNullimpl(mo1917trySendJP2dKIU);
