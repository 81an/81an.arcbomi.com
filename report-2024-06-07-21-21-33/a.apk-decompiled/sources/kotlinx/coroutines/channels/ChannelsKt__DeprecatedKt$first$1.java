...
@DebugMetadata(c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt", f = "Deprecated.kt", i = {0, 0}, l = {RegisterRequest.U2F_V1_CHALLENGE_BYTE_LENGTH}, m = "first", n = {"$this$consume$iv", "iterator"}, s = {"L$0", "L$1"})
