...
public final class SelectInstance<R> extends LockFreeLinkedListHead implements SelectBuilder<R>, kotlinx.coroutines.selects.SelectInstance<R>, Continuation<R>, CoroutineStackFrame {
    ...
    public final void handleBuilderException(Throwable e) {
        if (trySelect()) {
            ...
            resumeWith(Result.m416constructorimpl(ResultKt.createFailure(e)));
        } else {
    ...
    public void resumeWith(Object result) {
        ...
        while (true) {
            ...
            if (obj == SelectKt.access$getUNDECIDED$p()) {
                ...
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_result$FU, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.access$getRESUMED$p())) {
                    if (Result.m422isFailureimpl(result)) {
                        Continuation<R> continuation = this.uCont;
                        Throwable m419exceptionOrNullimpl = Result.m419exceptionOrNullimpl(result);
                        Intrinsics.checkNotNull(m419exceptionOrNullimpl);
                        Result.Companion companion = Result.INSTANCE;
                        if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                            m419exceptionOrNullimpl = StackTraceRecoveryKt.recoverFromStackFrame(m419exceptionOrNullimpl, (CoroutineStackFrame) continuation);
                        }
                        continuation.resumeWith(Result.m416constructorimpl(ResultKt.createFailure(m419exceptionOrNullimpl)));
                        return;
                    }
        ...
        while (true) {
            ...
            if (obj == SelectKt.access$getUNDECIDED$p()) {
                ...
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_result$FU, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), SelectKt.access$getRESUMED$p())) {
                    ...
                    Result.Companion companion = Result.INSTANCE;
                    intercepted.resumeWith(Result.m416constructorimpl(ResultKt.createFailure(exception)));
                    return;
                }
            }
        }
