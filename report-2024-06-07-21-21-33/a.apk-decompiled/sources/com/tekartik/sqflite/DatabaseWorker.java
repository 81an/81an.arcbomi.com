...
public class DatabaseWorker {
    ...
    public void postTask(final DatabaseTask databaseTask) {
        this.handler.post(new Runnable() { // from class: com.tekartik.sqflite.DatabaseWorker$$ExternalSyntheticLambda0
            ...
            public final void run() {
                DatabaseWorker.this.m263lambda$postTask$0$comtekartiksqfliteDatabaseWorker(databaseTask);
            }
        });
    }
    ...
    public void m263lambda$postTask$0$comtekartiksqfliteDatabaseWorker(DatabaseTask databaseTask) {
