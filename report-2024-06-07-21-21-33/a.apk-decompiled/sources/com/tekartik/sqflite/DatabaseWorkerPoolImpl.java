...
public class DatabaseWorkerPoolImpl implements DatabaseWorkerPool {
        ...
        for (int i = 0; i < this.numberOfWorkers; i++) {
            ...
            createWorker.start(new Runnable() { // from class: com.tekartik.sqflite.DatabaseWorkerPoolImpl$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    DatabaseWorkerPoolImpl.this.m264lambda$start$0$comtekartiksqfliteDatabaseWorkerPoolImpl(createWorker);
                }
            });
    ...
    public synchronized void m264lambda$start$0$comtekartiksqfliteDatabaseWorkerPoolImpl(DatabaseWorker databaseWorker) {
