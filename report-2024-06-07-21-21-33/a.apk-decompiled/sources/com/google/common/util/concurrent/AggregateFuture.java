...
public abstract class AggregateFuture<InputT, OutputT> extends AggregateFutureState<OutputT> {
    ...
    public final void init() {
            ...
            while (it.hasNext()) {
                ...
                next.addListener(new Runnable() { // from class: com.google.common.util.concurrent.AggregateFuture$$ExternalSyntheticLambda1
                    ...
                    public final void run() {
                        AggregateFuture.this.m55lambda$init$0$comgooglecommonutilconcurrentAggregateFuture(next, i);
                    }
        ...
        Runnable runnable = new Runnable() { // from class: com.google.common.util.concurrent.AggregateFuture$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                AggregateFuture.this.m56lambda$init$1$comgooglecommonutilconcurrentAggregateFuture(immutableCollection);
            }
        };
    ...
    public /* synthetic */ void m55lambda$init$0$comgooglecommonutilconcurrentAggregateFuture(ListenableFuture listenableFuture, int i) {
        try {
            ...
            m56lambda$init$1$comgooglecommonutilconcurrentAggregateFuture(null);
        }
    }
    ...
    public void m56lambda$init$1$comgooglecommonutilconcurrentAggregateFuture(@CheckForNull ImmutableCollection<? extends Future<? extends InputT>> immutableCollection) {
