...
public class Repo implements PersistentConnection.Delegate {
    ...
    public class AnonymousClass9 implements Runnable {
            ...
            if (serverValue == null) {
                ...
                task.addOnCompleteListener(executorService, new OnCompleteListener() { // from class: com.google.firebase.database.core.Repo$9$$ExternalSyntheticLambda0
                    ...
                    public final void onComplete(Task task2) {
                        Repo.AnonymousClass9.this.m89lambda$run$1$comgooglefirebasedatabasecoreRepo$9(taskCompletionSource2, persistenceServerCache, query, repo2, task2);
                    }
                });
                return;
            }
        ...
        public /* synthetic */ void m89lambda$run$1$comgooglefirebasedatabasecoreRepo$9(TaskCompletionSource taskCompletionSource, DataSnapshot dataSnapshot, Query query, Repo repo, Task task) {
