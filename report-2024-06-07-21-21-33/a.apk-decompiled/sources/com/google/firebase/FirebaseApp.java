...
public class FirebaseApp {
    ...
    protected FirebaseApp(final Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        this.dataCollectionConfigStorage = new Lazy<>(new Provider() { // from class: com.google.firebase.FirebaseApp$$ExternalSyntheticLambda1
            ...
            public final Object get() {
                return FirebaseApp.this.m58lambda$new$0$comgooglefirebaseFirebaseApp(context);
            }
        });
        ...
        addBackgroundStateChangeListener(new BackgroundStateChangeListener() { // from class: com.google.firebase.FirebaseApp$$ExternalSyntheticLambda0
            ...
            public final void onBackgroundStateChanged(boolean z) {
                FirebaseApp.this.m59lambda$new$1$comgooglefirebaseFirebaseApp(z);
            }
        });
        FirebaseTrace.popTrace();
    }
    ...
    public /* synthetic */ DataCollectionConfigStorage m58lambda$new$0$comgooglefirebaseFirebaseApp(Context context) {
    ...
    public /* synthetic */ void m59lambda$new$1$comgooglefirebaseFirebaseApp(boolean z) {
        if (z) {
            return;
        }
