...
public final class RemoteStore implements WatchChangeAggregator.TargetMetadataProvider {
    ...
    public RemoteStore(final RemoteStoreCallback remoteStoreCallback, LocalStore localStore, Datastore datastore, final AsyncQueue asyncQueue, ConnectivityMonitor connectivityMonitor) {
        ...
        connectivityMonitor.addCallback(new Consumer() { // from class: com.google.firebase.firestore.remote.RemoteStore$$ExternalSyntheticLambda1
            ...
            public final void accept(Object obj) {
                RemoteStore.this.m217lambda$new$1$comgooglefirebasefirestoreremoteRemoteStore(asyncQueue, (ConnectivityMonitor.NetworkStatus) obj);
            }
        });
    }
    ...
    public /* synthetic */ void m217lambda$new$1$comgooglefirebasefirestoreremoteRemoteStore(AsyncQueue asyncQueue, final ConnectivityMonitor.NetworkStatus networkStatus) {
        asyncQueue.enqueueAndForget(new Runnable() { // from class: com.google.firebase.firestore.remote.RemoteStore$$ExternalSyntheticLambda2
            ...
            public final void run() {
                RemoteStore.this.m216lambda$new$0$comgooglefirebasefirestoreremoteRemoteStore(networkStatus);
            }
        });
    }
    ...
    public /* synthetic */ void m216lambda$new$0$comgooglefirebasefirestoreremoteRemoteStore(ConnectivityMonitor.NetworkStatus networkStatus) {
