...
public class Datastore {
    ...
    public Task<List<MutationResult>> commit(List<Mutation> list) {
        ...
        return this.channel.runRpc(FirestoreGrpc.getCommitMethod(), newBuilder.build()).continueWith(this.workerQueue.getExecutor(), new Continuation() { // from class: com.google.firebase.firestore.remote.Datastore$$ExternalSyntheticLambda0
            ...
            public final Object then(Task task) {
                return Datastore.this.m203lambda$commit$0$comgooglefirebasefirestoreremoteDatastore(task);
            }
        });
    }
    ...
    public /* synthetic */ List m203lambda$commit$0$comgooglefirebasefirestoreremoteDatastore(Task task) throws Exception {
    ...
    public Task<Long> runCountQuery(Query query) {
        ...
        return this.channel.runRpc(FirestoreGrpc.getRunAggregationQueryMethod(), newBuilder3.build()).continueWith(this.workerQueue.getExecutor(), new Continuation() { // from class: com.google.firebase.firestore.remote.Datastore$$ExternalSyntheticLambda1
            @Override // com.google.android.gms.tasks.Continuation
            public final Object then(Task task) {
                return Datastore.this.m204x3ddca980(task);
            }
        });
    }
    ...
    public /* synthetic */ Long m204x3ddca980(Task task) throws Exception {
        if (!task.isSuccessful()) {
            if ((task.getException() instanceof FirebaseFirestoreException) && ((FirebaseFirestoreException) task.getException()).getCode() == FirebaseFirestoreException.Code.UNAUTHENTICATED) {
                this.channel.invalidateToken();
            }
