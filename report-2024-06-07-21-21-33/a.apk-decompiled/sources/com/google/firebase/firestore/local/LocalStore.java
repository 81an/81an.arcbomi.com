...
public final class LocalStore implements BundleCallback {
    ...
    public /* synthetic */ void m151xf9470190() {
        this.indexManager.start();
    }

    private void startMutationQueue() {
        this.persistence.runTransaction("Start MutationQueue", new Runnable() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                LocalStore.this.m152xa2ea7b8c();
            }
        });
    }
    ...
    public /* synthetic */ void m152xa2ea7b8c() {
    ...
    public LocalDocumentsResult writeLocally(final List<Mutation> list) {
        ...
        return (LocalDocumentsResult) this.persistence.runTransaction("Locally write mutations", new Supplier() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda1
            ...
            public final Object get() {
                return LocalStore.this.m153x4f0ff958(hashSet, list, now);
            }
        });
    }
    ...
    public /* synthetic */ LocalDocumentsResult m153x4f0ff958(Set set, List list, Timestamp timestamp) {
    ...
    public ImmutableSortedMap<DocumentKey, Document> acknowledgeBatch(final MutationBatchResult mutationBatchResult) {
        return (ImmutableSortedMap) this.persistence.runTransaction("Acknowledge batch", new Supplier() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda17
            @Override // com.google.firebase.firestore.util.Supplier
            public final Object get() {
                return LocalStore.this.m136xd0c8f3b2(mutationBatchResult);
            }
        });
    }
    ...
    public /* synthetic */ ImmutableSortedMap m136xd0c8f3b2(MutationBatchResult mutationBatchResult) {
    ...
    public ImmutableSortedMap<DocumentKey, Document> rejectBatch(final int i) {
        return (ImmutableSortedMap) this.persistence.runTransaction("Reject batch", new Supplier() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda13
            @Override // com.google.firebase.firestore.util.Supplier
            public final Object get() {
                return LocalStore.this.m146x1ab75fae(i);
            }
        });
    }
    ...
    public /* synthetic */ ImmutableSortedMap m146x1ab75fae(int i) {
    ...
    public void setLastStreamToken(final ByteString byteString) {
        this.persistence.runTransaction("Set stream token", new Runnable() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
                LocalStore.this.m150x6c1835ed(byteString);
            }
        });
    }
    ...
    public /* synthetic */ void m150x6c1835ed(ByteString byteString) {
    ...
    public ImmutableSortedMap<DocumentKey, Document> applyRemoteEvent(final RemoteEvent remoteEvent) {
        ...
        return (ImmutableSortedMap) this.persistence.runTransaction("Apply remote event", new Supplier() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda18
            @Override // com.google.firebase.firestore.util.Supplier
            public final Object get() {
                return LocalStore.this.m139xfb616aa7(remoteEvent, snapshotVersion);
            }
        });
    }
    ...
    public /* synthetic */ ImmutableSortedMap m139xfb616aa7(RemoteEvent remoteEvent, SnapshotVersion snapshotVersion) {
    ...
    public void notifyLocalViewChanges(final List<LocalViewChanges> list) {
        this.persistence.runTransaction("notifyLocalViewChanges", new Runnable() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda10
            @Override // java.lang.Runnable
            public final void run() {
                LocalStore.this.m145x6c8bed50(list);
            }
        });
    }
    ...
    public /* synthetic */ void m145x6c8bed50(List list) {
        Iterator it = list.iterator();
        while (it.hasNext()) {
    ...
    public TargetData allocateTarget(final Target target) {
        ...
        if (targetData != null) {
            ...
            this.persistence.runTransaction("Allocate target", new Runnable() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda7
                @Override // java.lang.Runnable
                public final void run() {
                    LocalStore.this.m137x5de91a9d(allocateQueryHolder, target);
                }
            });
    ...
    public /* synthetic */ void m137x5de91a9d(AllocateQueryHolder allocateQueryHolder, Target target) {
    ...
    public boolean hasNewerBundle(final BundleMetadata bundleMetadata) {
        return ((Boolean) this.persistence.runTransaction("Has newer bundle", new Supplier() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda15
            @Override // com.google.firebase.firestore.util.Supplier
            public final Object get() {
                return LocalStore.this.m144x622d6455(bundleMetadata);
            }
        })).booleanValue();
    }
    ...
    public /* synthetic */ Boolean m144x622d6455(BundleMetadata bundleMetadata) {
    ...
    public void saveBundle(final BundleMetadata bundleMetadata) {
        this.persistence.runTransaction("Save bundle", new Runnable() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                LocalStore.this.m148x98d21eb5(bundleMetadata);
            }
        });
    }
    ...
    public /* synthetic */ void m148x98d21eb5(BundleMetadata bundleMetadata) {
    ...
    public ImmutableSortedMap<DocumentKey, Document> applyBundledDocuments(final ImmutableSortedMap<DocumentKey, MutableDocument> immutableSortedMap, String str) {
        ...
        return (ImmutableSortedMap) this.persistence.runTransaction("Apply bundle documents", new Supplier() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda14
            @Override // com.google.firebase.firestore.util.Supplier
            public final Object get() {
                return LocalStore.this.m138xda7cc59f(immutableSortedMap, allocateTarget);
            }
        });
    }
    ...
    public /* synthetic */ ImmutableSortedMap m138xda7cc59f(ImmutableSortedMap immutableSortedMap, TargetData targetData) {
        ImmutableSortedSet<DocumentKey> emptyKeySet = DocumentKey.emptyKeySet();
        HashMap hashMap = new HashMap();
    ...
    public void saveNamedQuery(final NamedQuery namedQuery, final ImmutableSortedSet<DocumentKey> immutableSortedSet) {
        ...
        this.persistence.runTransaction("Saved named query", new Runnable() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                LocalStore.this.m149x3730c4c0(namedQuery, allocateTarget, targetId, immutableSortedSet);
            }
        });
    }
    ...
    public /* synthetic */ void m149x3730c4c0(NamedQuery namedQuery, TargetData targetData, int i, ImmutableSortedSet immutableSortedSet) {
    ...
    public NamedQuery getNamedQuery(final String str) {
        return (NamedQuery) this.persistence.runTransaction("Get named query", new Supplier() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda19
            @Override // com.google.firebase.firestore.util.Supplier
            public final Object get() {
                return LocalStore.this.m143x4cee2ade(str);
            }
        });
    }
    ...
    public /* synthetic */ NamedQuery m143x4cee2ade(String str) {
        return this.bundleCache.getNamedQuery(str);
    }

    Collection<FieldIndex> getFieldIndexes() {
        return (Collection) this.persistence.runTransaction("Get indexes", new Supplier() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda12
            @Override // com.google.firebase.firestore.util.Supplier
            public final Object get() {
                return LocalStore.this.m142x64aa3c54();
            }
        });
    }
    ...
    public /* synthetic */ Collection m142x64aa3c54() {
        return this.indexManager.getFieldIndexes();
    }

    public void configureFieldIndexes(final List<FieldIndex> list) {
        this.persistence.runTransaction("Configure indexes", new Runnable() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
                LocalStore.this.m141x4fad3f83(list);
            }
        });
    }
    ...
    public /* synthetic */ void m141x4fad3f83(List list) {
    ...
    public void releaseTarget(final int i) {
        this.persistence.runTransaction("Release target", new Runnable() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                LocalStore.this.m147x1dfd2d2e(i);
            }
        });
    }
    ...
    public /* synthetic */ void m147x1dfd2d2e(int i) {
    ...
    public LruGarbageCollector.Results collectGarbage(final LruGarbageCollector lruGarbageCollector) {
        return (LruGarbageCollector.Results) this.persistence.runTransaction("Collect garbage", new Supplier() { // from class: com.google.firebase.firestore.local.LocalStore$$ExternalSyntheticLambda16
            @Override // com.google.firebase.firestore.util.Supplier
            public final Object get() {
                return LocalStore.this.m140x1db5499a(lruGarbageCollector);
            }
        });
    }
    ...
    public /* synthetic */ LruGarbageCollector.Results m140x1db5499a(LruGarbageCollector lruGarbageCollector) {
