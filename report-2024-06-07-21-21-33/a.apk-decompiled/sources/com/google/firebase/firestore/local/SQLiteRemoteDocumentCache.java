...
public final class SQLiteRemoteDocumentCache implements RemoteDocumentCache {
        ...
        while (longQuery.hasMoreSubqueries()) {
            longQuery.performNextSubquery().forEach(new Consumer() { // from class: com.google.firebase.firestore.local.SQLiteRemoteDocumentCache$$ExternalSyntheticLambda0
                ...
                public final void accept(Object obj) {
                    SQLiteRemoteDocumentCache.this.m175xca14d1c3(backgroundQueue, hashMap, (Cursor) obj);
                }
            });
        }
    ...
    public /* synthetic */ void m175xca14d1c3(BackgroundQueue backgroundQueue, Map map, Cursor cursor) {
        m176xbda45604(backgroundQueue, map, cursor, null);
    }
    ...
    private Map<DocumentKey, MutableDocument> getAll(List<ResourcePath> list, FieldIndex.IndexOffset indexOffset, int i, @Nullable final Function<MutableDocument, Boolean> function) {
        ...
        this.db.query(repeatSequence.toString()).binding(objArr).forEach(new Consumer() { // from class: com.google.firebase.firestore.local.SQLiteRemoteDocumentCache$$ExternalSyntheticLambda1
            @Override // com.google.firebase.firestore.util.Consumer
            public final void accept(Object obj) {
                SQLiteRemoteDocumentCache.this.m176xbda45604(backgroundQueue, hashMap, function, (Cursor) obj);
            }
        });
        backgroundQueue.drain();
        return hashMap;
    ...
    public void m176xbda45604(BackgroundQueue backgroundQueue, final Map<DocumentKey, MutableDocument> map, Cursor cursor, @Nullable final Function<MutableDocument, Boolean> function) {
        ...
        backgroundQueue2.execute(new Runnable() { // from class: com.google.firebase.firestore.local.SQLiteRemoteDocumentCache$$ExternalSyntheticLambda3
            ...
            public final void run() {
                SQLiteRemoteDocumentCache.this.m177x16ef698(blob, i, i2, function, map);
            }
        });
    }
    ...
    public /* synthetic */ void m177x16ef698(byte[] bArr, int i, int i2, Function function, Map map) {
