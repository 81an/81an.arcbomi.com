...
public final class SetMutation extends Mutation {
    ...
    public void applyToRemoteDocument(MutableDocument mutableDocument, MutationResult mutationResult) {
        ...
        ObjectValue m194clone = this.value.m194clone();
        m194clone.setAll(serverTransformResults(mutableDocument, mutationResult.getTransformResults()));
        mutableDocument.convertToFoundDocument(mutationResult.getVersion(), m194clone).setHasCommittedMutations();
    }
    ...
    public FieldMask applyToLocalView(MutableDocument mutableDocument, FieldMask fieldMask, Timestamp timestamp) {
        ...
        ObjectValue m194clone = this.value.m194clone();
        m194clone.setAll(localTransformResults);
        mutableDocument.convertToFoundDocument(mutableDocument.getVersion(), m194clone).setHasLocalMutations();
        return null;
    }
