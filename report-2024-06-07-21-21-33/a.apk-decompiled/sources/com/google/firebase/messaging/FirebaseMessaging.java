...
public class FirebaseMessaging {
    ...
    FirebaseMessaging(FirebaseApp firebaseApp, FirebaseInstanceIdInternal firebaseInstanceIdInternal, FirebaseInstallationsApi firebaseInstallationsApi, TransportFactory transportFactory2, Subscriber subscriber, Metadata metadata, GmsRpc gmsRpc, Executor executor, Executor executor2, Executor executor3) {
        ...
        if (firebaseInstanceIdInternal != null) {
            firebaseInstanceIdInternal.addNewTokenListener(new FirebaseInstanceIdInternal.NewTokenListener() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda5
                ...
                public final void onNewToken(String str) {
                    FirebaseMessaging.this.m236lambda$new$0$comgooglefirebasemessagingFirebaseMessaging(str);
                }
            });
        }
        executor2.execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda7
            ...
            public final void run() {
                FirebaseMessaging.this.m237lambda$new$1$comgooglefirebasemessagingFirebaseMessaging();
            }
        });
        ...
        createInstance.addOnSuccessListener(executor2, new OnSuccessListener() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda0
            ...
            public final void onSuccess(Object obj) {
                FirebaseMessaging.this.m238lambda$new$2$comgooglefirebasemessagingFirebaseMessaging((TopicsSubscriber) obj);
            }
        });
        executor2.execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
                FirebaseMessaging.this.m239lambda$new$3$comgooglefirebasemessagingFirebaseMessaging();
            }
        });
    }
    ...
    public /* synthetic */ void m237lambda$new$1$comgooglefirebasemessagingFirebaseMessaging() {
    ...
    public /* synthetic */ void m238lambda$new$2$comgooglefirebasemessagingFirebaseMessaging(TopicsSubscriber topicsSubscriber) {
        if (isAutoInitEnabled()) {
    ...
    public /* synthetic */ void m239lambda$new$3$comgooglefirebasemessagingFirebaseMessaging() {
    ...
    public Task<String> getToken() {
        ...
        this.initExecutor.execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                FirebaseMessaging.this.m235x6bb67082(taskCompletionSource);
            }
        });
    ...
    public /* synthetic */ void m235x6bb67082(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    public Task<Void> deleteToken() {
        if (this.iid != null) {
            ...
            this.initExecutor.execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda9
                @Override // java.lang.Runnable
                public final void run() {
                    FirebaseMessaging.this.m233xd6d6bd74(taskCompletionSource);
                }
            });
            return taskCompletionSource.getTask();
        }
        ...
        FcmExecutors.newNetworkIOExecutor().execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda10
            @Override // java.lang.Runnable
            public final void run() {
                FirebaseMessaging.this.m234xd6605775(taskCompletionSource2);
            }
        });
    ...
    public /* synthetic */ void m233xd6d6bd74(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    public /* synthetic */ void m234xd6605775(TaskCompletionSource taskCompletionSource) {
        try {
        ...
        try {
            return (String) Tasks.await(this.requestDeduplicator.getOrStartGetTokenRequest(defaultSenderId, new RequestDeduplicator.GetTokenRequest() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda6
                ...
                public final Task start() {
                    return FirebaseMessaging.this.m231xb9ac49c0(defaultSenderId, tokenWithoutTriggeringSync);
                }
            }));
    ...
    public /* synthetic */ Task m231xb9ac49c0(final String str, final Store.Token token) {
        return this.gmsRpc.getToken().onSuccessTask(this.fileExecutor, new SuccessContinuation() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda2
            @Override // com.google.android.gms.tasks.SuccessContinuation
            public final Task then(Object obj) {
                return FirebaseMessaging.this.m232xa77f119c(str, token, (String) obj);
            }
        });
    }
    ...
    public /* synthetic */ Task m232xa77f119c(String str, Store.Token token, String str2) throws Exception {
        getStore(this.context).saveToken(getSubtype(), str, str2, this.metadata.getAppVersionCode());
        if (token == null || !str2.equals(token.token)) {
            m236lambda$new$0$comgooglefirebasemessagingFirebaseMessaging(str2);
        }
    ...
    public void m236lambda$new$0$comgooglefirebasemessagingFirebaseMessaging(String str) {
    ...
    public class AutoInit {
            ...
            if (readEnabled == null) {
                EventHandler<DataCollectionDefaultChange> eventHandler = new EventHandler() { // from class: com.google.firebase.messaging.FirebaseMessaging$AutoInit$$ExternalSyntheticLambda0
                    ...
                    public final void handle(Event event) {
                        FirebaseMessaging.AutoInit.this.m240x1061f0b8(event);
                    }
                };
        ...
        public /* synthetic */ void m240x1061f0b8(Event event) {
            if (isEnabled()) {
