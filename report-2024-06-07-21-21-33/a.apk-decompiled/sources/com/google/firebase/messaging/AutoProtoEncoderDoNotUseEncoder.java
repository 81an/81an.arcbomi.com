...
public final class AutoProtoEncoderDoNotUseEncoder implements Configurator {
    ...
    private static final class MessagingClientEventEncoder implements ObjectEncoder<MessagingClientEvent> {
        ...
        private static final FieldDescriptor PACKAGENAME_DESCRIPTOR = FieldDescriptor.builder(io.flutter.plugins.firebase.auth.Constants.PACKAGE_NAME).withProperty(AtProtobuf.builder().tag(6).build()).build();
        ...
        private static final FieldDescriptor PRIORITY_DESCRIPTOR = FieldDescriptor.builder(io.flutter.plugins.firebase.database.Constants.PRIORITY).withProperty(AtProtobuf.builder().tag(8).build()).build();
