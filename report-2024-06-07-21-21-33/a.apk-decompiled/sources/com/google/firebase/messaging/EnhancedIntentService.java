...
public abstract class EnhancedIntentService extends Service {
    ...
    public Task<Void> processIntent(final Intent intent) {
        ...
        this.executor.execute(new Runnable() { // from class: com.google.firebase.messaging.EnhancedIntentService$$ExternalSyntheticLambda1
            ...
            public final void run() {
                EnhancedIntentService.this.m229x624ce8b2(intent, taskCompletionSource);
            }
        });
    ...
    public /* synthetic */ void m229x624ce8b2(Intent intent, TaskCompletionSource taskCompletionSource) {
        try {
            handleIntent(intent);
        } finally {
    ...
    public final int onStartCommand(final Intent intent, int i, int i2) {
        ...
        processIntent.addOnCompleteListener(WindowInfoTrackerImpl$windowLayoutInfo$1$$ExternalSyntheticLambda1.INSTANCE, new OnCompleteListener() { // from class: com.google.firebase.messaging.EnhancedIntentService$$ExternalSyntheticLambda0
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
                EnhancedIntentService.this.m228x83fa35aa(intent, task);
            }
        });
        return 3;
    }
    ...
    public /* synthetic */ void m228x83fa35aa(Intent intent, Task task) {
        finishTask(intent);
    }
