...
public class GmsRpc {
    ...
    private Task<String> extractResponseWhenComplete(Task<Bundle> task) {
        return task.continueWith(WindowInfoTrackerImpl$windowLayoutInfo$1$$ExternalSyntheticLambda1.INSTANCE, new Continuation() { // from class: com.google.firebase.messaging.GmsRpc$$ExternalSyntheticLambda0
            @Override // com.google.android.gms.tasks.Continuation
            public final Object then(Task task2) {
                return GmsRpc.this.m241xb80eb67f(task2);
            }
        });
    }
    ...
    public /* synthetic */ String m241xb80eb67f(Task task) throws Exception {
