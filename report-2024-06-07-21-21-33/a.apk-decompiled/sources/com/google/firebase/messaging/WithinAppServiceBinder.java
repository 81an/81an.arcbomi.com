...
public class WithinAppServiceBinder extends Binder {
    ...
    public void send(final WithinAppServiceConnection.BindRequest bindRequest) {
        ...
        this.intentHandler.handle(bindRequest.intent).addOnCompleteListener(WindowInfoTrackerImpl$windowLayoutInfo$1$$ExternalSyntheticLambda1.INSTANCE, new OnCompleteListener() { // from class: com.google.firebase.messaging.WithinAppServiceBinder$$ExternalSyntheticLambda0
