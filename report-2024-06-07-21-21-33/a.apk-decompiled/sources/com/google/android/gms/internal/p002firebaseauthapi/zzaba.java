...
public final class zzaba implements zzxn {
    ...
    public final /* bridge */ /* synthetic */ zzxn zza(String str) throws zzvg {
        try {
            ...
            this.zzd = Strings.emptyToNull(jSONObject.optString(Constants.REFRESH_TOKEN, null));
            ...
            this.zzh = Strings.emptyToNull(jSONObject.optString(Constants.DISPLAY_NAME, null));
            this.zzi = Strings.emptyToNull(jSONObject.optString("photoUrl", null));
            this.zzj = Strings.emptyToNull(jSONObject.optString(Constants.PROVIDER_ID, null));
            this.zzk = Strings.emptyToNull(jSONObject.optString("rawUserInfo", null));
            this.zzl = jSONObject.optBoolean(Constants.IS_NEW_USER, false);
            ...
            this.zzr = Strings.emptyToNull(jSONObject.optString(Constants.TENANT_ID, null));
