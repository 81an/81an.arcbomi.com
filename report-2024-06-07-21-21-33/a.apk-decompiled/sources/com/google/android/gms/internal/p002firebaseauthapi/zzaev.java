...
interface zzaev {
    ...
    @Deprecated
    void zzC(List list, zzaew zzaewVar, zzacs zzacsVar) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzaew zzaewVar, zzacs zzacsVar) throws IOException;
    ...
    zzacc zzp() throws IOException;

    String zzr() throws IOException;

    String zzs() throws IOException;

    void zzt(Object obj, zzaew zzaewVar, zzacs zzacsVar) throws IOException;

    void zzu(Object obj, zzaew zzaewVar, zzacs zzacsVar) throws IOException;
