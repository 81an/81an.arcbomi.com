...
public final class zzlp<T> implements zzlx<T> {
            ...
            switch (zzA14) {
                ...
                case 9:
                    if ((i8 & i) == 0) {
                        ...
                        zzA5 = zzlz.zzo(i10, unsafe.getObject(obj, j), zzE(i6));
                        i7 += zzA5;
                        break;
                    }
                case 10:
                ...
                case 16:
                    if ((i & i8) == 0) {
                        ...
                        i7 += zzjm.zzA(i10 << 3) + zzjm.zzB((j4 >> 63) ^ (j4 + j4));
                        break;
                    }
                case 17:
                    if ((i8 & i) == 0) {
                        ...
                        zzA5 = zzjm.zzu(i10, (zzlm) unsafe.getObject(obj, j), zzE(i6));
                        i7 += zzA5;
                        break;
                    }
                case 18:
                ...
                case 26:
                    ...
                    break;
                case 27:
                    zzu = zzlz.zzp(i10, (List) unsafe.getObject(obj, j), zzE(i6));
                    i7 += zzu;
                    break;
                case 28:
                ...
                case Service.SYSTEM_PARAMETERS_FIELD_NUMBER /* 29 */:
                    ...
                    break;
                case 30:
                    zzu = zzlz.zzd(i10, (List) unsafe.getObject(obj, j), false);
                    i7 += zzu;
                    break;
                case DescriptorProtos.FileOptions.CC_ENABLE_ARENAS_FIELD_NUMBER /* 31 */:
                    zzu = zzlz.zzf(i10, (List) unsafe.getObject(obj, j), false);
                    i7 += zzu;
                    break;
                case 32:
                    zzu = zzlz.zzh(i10, (List) unsafe.getObject(obj, j), false);
                    i7 += zzu;
                    break;
                case 33:
                    zzu = zzlz.zzq(i10, (List) unsafe.getObject(obj, j), false);
                    i7 += zzu;
                    break;
                case 34:
                    zzu = zzlz.zzs(i10, (List) unsafe.getObject(obj, j), false);
                    i7 += zzu;
                    break;
                case MotionEventCompat.AXIS_GENERIC_4 /* 35 */:
                ...
                case 48:
                    ...
                    break;
                case 49:
                    zzu = zzlz.zzj(i10, (List) unsafe.getObject(obj, j), zzE(i6));
                    i7 += zzu;
                    break;
                case FirestoreIndexValueWriter.INDEX_TYPE_ARRAY /* 50 */:
                    zzlh.zza(i10, unsafe.getObject(obj, j), zzF(i6));
                    break;
                case 51:
                    if (zzX(obj, i10, i6)) {
                        zzA9 = zzjm.zzA(i10 << 3);
                ...
                case 60:
                    if (zzX(obj, i10, i6)) {
                        zzu = zzlz.zzo(i10, unsafe.getObject(obj, j), zzE(i6));
                        i7 += zzu;
                    }
                    break;
                case LockFreeTaskQueueCore.CLOSED_SHIFT /* 61 */:
                ...
                case 67:
                    if (zzX(obj, i10, i6)) {
                        long zzC3 = zzC(obj, j);
                        i7 += zzjm.zzA(i10 << 3) + zzjm.zzB((zzC3 >> 63) ^ (zzC3 + zzC3));
                    }
                    break;
                case 68:
                    if (zzX(obj, i10, i6)) {
                        zzu = zzjm.zzu(i10, (zzlm) unsafe.getObject(obj, j), zzE(i6));
                        i7 += zzu;
                    }
                    break;
            }
    ...
    */
        ...
        switch (i7) {
                ...
                if (i5 == 2) {
                    if ((j & 536870912) != 0) {
                        ...
                        if (i19 == 0) {
                            ...
                            int i20 = i12 + i19;
                            if (!zznd.zzf(bArr, i12, i20)) {
                                throw zzkp.zzc();
                            }
                            zzkmVar.add(new String(bArr, i12, i19, zzkn.zzb));
                            i12 = i20;
                        }
                        while (i12 < i2) {
                            int zzj9 = zzis.zzj(bArr, i12, zzirVar);
                            if (i3 == zzirVar.zza) {
                                i12 = zzis.zzj(bArr, zzj9, zzirVar);
                                int i21 = zzirVar.zza;
                                if (i21 < 0) {
                                    throw zzkp.zzd();
                                }
                                if (i21 == 0) {
                                    ...
                                    int i22 = i12 + i21;
                                    if (zznd.zzf(bArr, i12, i22)) {
                                        zzkmVar.add(new String(bArr, i12, i21, zzkn.zzb));
                                        i12 = i22;
                                    } else {
                                        throw zzkp.zzc();
                                    }
                        ...
                        if (i23 == 0) {
                            ...
                            zzkmVar.add(new String(bArr, i12, i23, zzkn.zzb));
                            i12 += i23;
                        }
                        while (i12 < i2) {
                            int zzj10 = zzis.zzj(bArr, i12, zzirVar);
                            if (i3 == zzirVar.zza) {
                                i12 = zzis.zzj(bArr, zzj10, zzirVar);
                                int i24 = zzirVar.zza;
                                if (i24 < 0) {
                                    throw zzkp.zzd();
                                }
                                if (i24 == 0) {
                                    ...
                                    zzkmVar.add(new String(bArr, i12, i24, zzkn.zzb));
                                    i12 += i24;
                                }
                            }
                        }
            ...
            case 28:
                if (i5 == 2) {
                    ...
                    if (i25 == 0) {
                        ...
                        zzkmVar.add(zzje.zzl(bArr, zzj11, i25));
                        zzj11 += i25;
                    }
                    while (zzj11 < i2) {
                        ...
                        if (i26 >= 0) {
                            ...
                            if (i26 == 0) {
                                ...
                                zzkmVar.add(zzje.zzl(bArr, zzj11, i26));
                                zzj11 += i26;
                            }
                        } else {
                            throw zzkp.zzd();
            ...
            case MotionEventCompat.AXIS_GENERIC_16 /* 47 */:
                ...
                if (i5 == 0) {
                    ...
                    int zzj14 = zzis.zzj(bArr, i12, zzirVar);
            ...
            default:
                if (i5 == 3) {
                    ...
                    while (zzc < i2) {
                        ...
                        zzc = zzis.zzc(zzE, bArr, zzj18, i2, i29, zzirVar);
                        zzkmVar.add(zzirVar.zzc);
                    }
                    return zzc;
                }
     ...
     */
    /* JADX WARN: Code restructure failed: missing block: B:39:0x042d, code lost:
     ...
     */
    /* JADX WARN: Code restructure failed: missing block: B:42:0x0446, code lost:
    ...
    /* JADX WARN: Code restructure failed: missing block: B:56:0x0466, code lost:
        ...
        return r0;
     */
    /* JADX WARN: Code restructure failed: missing block: B:58:0x0462, code lost:
    ...
    /* JADX WARN: Code restructure failed: missing block: B:61:0x046b, code lost:
        ...
        throw com.google.android.gms.internal.measurement.zzkp.zze();
     */
    /* JADX WARN: Failed to find 'out' block for switch in B:116:0x0095. Please report as an issue. */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
