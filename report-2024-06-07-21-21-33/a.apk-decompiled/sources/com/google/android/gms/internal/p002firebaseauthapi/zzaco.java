    ...
    public final void zzB(int i, List list, boolean z) throws IOException {
        ...
        if (!z) {
            while (i2 < list.size()) {
                ...
                zzacnVar.zzr(i, (intValue >> 31) ^ (intValue + intValue));
                i2++;
            }
            return;
        }
        ...
        for (int i4 = 0; i4 < list.size(); i4++) {
            ...
            i3 += zzacn.zzE((intValue2 >> 31) ^ (intValue2 + intValue2));
        }
        this.zza.zzs(i3);
        while (i2 < list.size()) {
            zzacn zzacnVar2 = this.zza;
            int intValue3 = ((Integer) list.get(i2)).intValue();
            zzacnVar2.zzs((intValue3 >> 31) ^ (intValue3 + intValue3));
            i2++;
        }
    }
    ...
    public final void zzD(int i, List list, boolean z) throws IOException {
        ...
        if (!z) {
            while (i2 < list.size()) {
                ...
                zzacnVar.zzt(i, (longValue >> 63) ^ (longValue + longValue));
                i2++;
            }
            return;
        }
        ...
        for (int i4 = 0; i4 < list.size(); i4++) {
            ...
            i3 += zzacn.zzF((longValue2 >> 63) ^ (longValue2 + longValue2));
        }
        this.zza.zzs(i3);
        while (i2 < list.size()) {
            zzacn zzacnVar2 = this.zza;
            long longValue3 = ((Long) list.get(i2)).longValue();
            zzacnVar2.zzu((longValue3 >> 63) ^ (longValue3 + longValue3));
            i2++;
        }
    }
