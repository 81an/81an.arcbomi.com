...
final class zzee extends zzgb {
    ...
    public final /* bridge */ /* synthetic */ zzaek zza(zzaek zzaekVar) throws GeneralSecurityException {
        ...
        ECPublicKey eCPublicKey = (ECPublicKey) zzd.getPublic();
        ECPrivateKey eCPrivateKey = (ECPrivateKey) zzd.getPrivate();
        ...
        zzmg zzmgVar = (zzmg) zzc.zzi();
        zzmc zzb = zzmd.zzb();
        zzb.zzc(0);
        zzb.zzb(zzmgVar);
        zzb.zza(zzacc.zzn(eCPrivateKey.getS().toByteArray()));
        return (zzmd) zzb.zzi();
    }
