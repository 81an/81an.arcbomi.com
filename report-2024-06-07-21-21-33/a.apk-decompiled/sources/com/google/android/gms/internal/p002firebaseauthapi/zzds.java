    ...
    public static byte[] zza(byte[] bArr, byte[] bArr2) {
        ...
        while (true) {
            ...
            if (i2 < length) {
                ...
                long zzc = (((j23 & j30) | (j25 & 67108863 & j31) | (j32 << 26)) & KeyboardMap.kValueMask) + zzc(bArr, 16);
                long zzc2 = (((j32 >> 6) | (j33 << 20)) & KeyboardMap.kValueMask) + zzc(bArr, 20) + (zzc >> 32);
                long zzc3 = (((j33 >> 12) | (j34 << 14)) & KeyboardMap.kValueMask) + zzc(bArr, 24) + (zzc2 >> 32);
                long zzc4 = zzc(bArr, 28);
                byte[] bArr4 = new byte[16];
                zzd(bArr4, zzc & KeyboardMap.kValueMask, 0);
                zzd(bArr4, zzc2 & KeyboardMap.kValueMask, 4);
                zzd(bArr4, zzc3 & KeyboardMap.kValueMask, 8);
                zzd(bArr4, ((((((j29 & j31) | (j21 & j30)) << 8) | (j34 >> 18)) & KeyboardMap.kValueMask) + zzc4 + (zzc3 >> 32)) & KeyboardMap.kValueMask, 12);
                return bArr4;
            }
        }
    }
