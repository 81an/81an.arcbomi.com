...
public final class zzaag extends AbstractSafeParcelable {
    ...
    public static zzaag zza(JSONArray jSONArray) throws JSONException {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            ...
            if (jSONObject != null) {
                zzaaeVar = new zzaae(Strings.emptyToNull(jSONObject.optString("federatedId", null)), Strings.emptyToNull(jSONObject.optString(Constants.DISPLAY_NAME, null)), Strings.emptyToNull(jSONObject.optString("photoUrl", null)), Strings.emptyToNull(jSONObject.optString(Constants.PROVIDER_ID, null)), null, Strings.emptyToNull(jSONObject.optString(Constants.PHONE_NUMBER, null)), Strings.emptyToNull(jSONObject.optString("email", null)));
            } else {
                zzaaeVar = new zzaae();
            }
