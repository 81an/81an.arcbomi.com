...
public final class zzaac extends AbstractSafeParcelable {
    ...
    public static zzaac zzb(JSONObject jSONObject) {
        zzaac zzaacVar = new zzaac(jSONObject.optString("phoneInfo", null), jSONObject.optString("mfaEnrollmentId", null), jSONObject.optString(Constants.DISPLAY_NAME, null), zzg(jSONObject.optString("enrolledAt", "")));
