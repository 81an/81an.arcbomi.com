...
public final class zzam extends zzkh {
    ...
    */
    ...
    /* JADX WARN: Not initialized variable reg: 4, insn: 0x0233: MOVE (r3 I:??[OBJECT, ARRAY]) = (r4 I:??[OBJECT, ARRAY]), block:B:121:0x0233 */
        ...
        try {
            try {
                ...
                try {
                    ...
                    String str4 = string;
                    try {
                        Cursor query = zzh2.query("raw_events_metadata", new String[]{Constants.METADATA}, "app_id = ? and metadata_fingerprint = ?", new String[]{str3, str4}, null, null, "rowid", "2");
                        try {
