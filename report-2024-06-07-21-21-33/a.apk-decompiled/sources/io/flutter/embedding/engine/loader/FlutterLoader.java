...
public class FlutterLoader {
    ...
    public void startInitialization(Context context, Settings settings) {
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT >= 17) {
                vsyncWaiter = VsyncWaiter.getInstance((DisplayManager) applicationContext.getSystemService(Constants.ScionAnalytics.MessageType.DISPLAY_NOTIFICATION), this.flutterJNI);
            } else {
    ...
    public class AnonymousClass1 implements Callable<InitResult> {
            ...
            try {
                ...
                FlutterLoader.this.executorService.execute(new Runnable() { // from class: io.flutter.embedding.engine.loader.FlutterLoader$1$$ExternalSyntheticLambda0
                    ...
                    public final void run() {
                        FlutterLoader.AnonymousClass1.this.m274lambda$call$0$ioflutterembeddingengineloaderFlutterLoader$1();
                    }
                });
        ...
        public /* synthetic */ void m274lambda$call$0$ioflutterembeddingengineloaderFlutterLoader$1() {
    ...
    */
    ...
    public void ensureInitializationCompleteAsync(final Context context, final String[] strArr, final Handler handler, final Runnable runnable) {
        ...
        if (this.initialized) {
            ...
            this.executorService.execute(new Runnable() { // from class: io.flutter.embedding.engine.loader.FlutterLoader$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    FlutterLoader.this.m273xa15f5dc1(context, strArr, handler, runnable);
                }
            });
        }
    }
    ...
    public /* synthetic */ void m273xa15f5dc1(final Context context, final String[] strArr, final Handler handler, final Runnable runnable) {
        try {
            ...
            HandlerCompat.createAsyncHandler(Looper.getMainLooper()).post(new Runnable() { // from class: io.flutter.embedding.engine.loader.FlutterLoader$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    FlutterLoader.this.m272xafb5b7a2(context, strArr, handler, runnable);
                }
            });
        } catch (Exception e) {
    ...
    public /* synthetic */ void m272xafb5b7a2(Context context, String[] strArr, Handler handler, Runnable runnable) {
