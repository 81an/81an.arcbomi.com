...
public class KeyEmbedderResponder implements KeyboardManager.Responder {
                ...
                if (i2 == 1) {
                    ...
                    if (!z) {
                        arrayList.add(new Runnable() { // from class: io.flutter.embedding.android.KeyEmbedderResponder$$ExternalSyntheticLambda1
                            ...
                            public final void run() {
                                KeyEmbedderResponder.this.m265x63b96e0c(keyPair, j2, keyEvent);
                            }
                        });
                    }
                } else if (i2 == 2) {
                    ...
                    if (!z) {
                        arrayList.add(new Runnable() { // from class: io.flutter.embedding.android.KeyEmbedderResponder$$ExternalSyntheticLambda2
                            @Override // java.lang.Runnable
                            public final void run() {
                                KeyEmbedderResponder.this.m266xa7448bcd(keyPair, keyEvent);
                            }
                        });
                    }
                    boolArr[i] = Boolean.valueOf(zArr[i]);
    ...
    public /* synthetic */ void m265x63b96e0c(KeyboardMap.KeyPair keyPair, long j, KeyEvent keyEvent) {
    ...
    public /* synthetic */ void m266xa7448bcd(KeyboardMap.KeyPair keyPair, KeyEvent keyEvent) {
