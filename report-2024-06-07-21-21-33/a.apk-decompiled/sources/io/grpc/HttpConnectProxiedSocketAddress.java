...
public final class HttpConnectProxiedSocketAddress extends ProxiedSocketAddress {
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this).add("proxyAddr", this.proxyAddress).add("targetAddr", this.targetAddress).add(Constants.USERNAME, this.username).add("hasPassword", this.password != null).toString();
    }
