...
public final class OkHttpServerTransport implements ServerTransport, ExceptionHandlingFrameWriter.TransportExceptionHandler, OutboundFlowController.Transport {
    ...
    private static final ByteString HOST = ByteString.encodeUtf8(Constants.HOST);
    ...
    public void start(ServerTransportListener serverTransportListener) {
        ...
        serializingExecutor.execute(new Runnable() { // from class: io.grpc.okhttp.OkHttpServerTransport$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                OkHttpServerTransport.this.m410lambda$start$0$iogrpcokhttpOkHttpServerTransport(serializingExecutor);
            }
        });
    }
    ...
    public void m410lambda$start$0$iogrpcokhttpOkHttpServerTransport(SerializingExecutor serializingExecutor) {
        try {
        ...
        synchronized (this.lock) {
            if (!this.gracefulShutdown && !this.abruptShutdown) {
                ...
                if (this.frameWriter == null) {
                    ...
                    this.secondGoawayTimer = this.scheduledExecutorService.schedule(new Runnable() { // from class: io.grpc.okhttp.OkHttpServerTransport$$ExternalSyntheticLambda2
                        @Override // java.lang.Runnable
                        public final void run() {
    ...
    public void abruptShutdown(ErrorCode errorCode, String str, Status status, boolean z) {
        synchronized (this.lock) {
            ...
            this.goAwayStreamId = this.lastStreamId;
            this.frameWriter.close();
            this.forcefulCloseTimer = this.scheduledExecutorService.schedule(new Runnable() { // from class: io.grpc.okhttp.OkHttpServerTransport$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
    ...
    public class FrameHandler implements FrameReader.Handler, Runnable {
        ...
        public void ping(boolean z, int i, int i2) {
            ...
            long j = (i << 32) | (i2 & KeyboardMap.kValueMask);
            if (!z) {
        ...
        private void respondWithHttpError(int i, boolean z, int i2, Status.Code code, String str) {
            ...
            synchronized (OkHttpServerTransport.this.lock) {
                ...
                OkHttpServerTransport.this.outboundFlow.notifyWhenNoPendingData(http2ErrorStreamState.getOutboundFlowState(), new Runnable() { // from class: io.grpc.okhttp.OkHttpServerTransport$FrameHandler$$ExternalSyntheticLambda0
                    @Override // java.lang.Runnable
                    public final void run() {
                        OkHttpServerTransport.FrameHandler.this.m411x6fc8eaa(http2ErrorStreamState);
                    }
                });
            }
        }
        ...
        public void m411x6fc8eaa(Http2ErrorStreamState http2ErrorStreamState) {
            synchronized (OkHttpServerTransport.this.lock) {
