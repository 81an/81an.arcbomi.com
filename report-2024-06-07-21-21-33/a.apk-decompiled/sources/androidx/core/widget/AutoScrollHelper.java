    ...
    public static class ClampedScroller {
        ...
        private float getValueAt(long currentTime) {
            ...
            if (j2 < 0 || currentTime < j2) {
                return AutoScrollHelper.constrain(((float) (currentTime - j)) / this.mRampUpDuration, 0.0f, AutoScrollHelper.DEFAULT_RELATIVE_VELOCITY) * 0.5f;
            }
            float f = this.mStopValue;
            return (AutoScrollHelper.DEFAULT_RELATIVE_VELOCITY - f) + (f * AutoScrollHelper.constrain(((float) (currentTime - j2)) / this.mEffectiveRampDown, 0.0f, AutoScrollHelper.DEFAULT_RELATIVE_VELOCITY));
        }
