...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mFillViewport && View.MeasureSpec.getMode(heightMeasureSpec) != 0 && getChildCount() > 0) {
            ...
            if (measuredHeight < measuredHeight2) {
                childAt.measure(getChildMeasureSpec(widthMeasureSpec, getPaddingLeft() + getPaddingRight() + layoutParams.leftMargin + layoutParams.rightMargin, layoutParams.width), View.MeasureSpec.makeMeasureSpec(measuredHeight2, Ints.MAX_POWER_OF_TWO));
            }
        }
    }
    ...
    */
    ...
    public final void smoothScrollBy(int dx, int dy) {
        smoothScrollBy(dx, dy, ExponentialBackoffSender.RND_MAX, false);
    }
    ...
    public final void smoothScrollTo(int x, int y) {
        smoothScrollTo(x, y, ExponentialBackoffSender.RND_MAX, false);
    }
    ...
    void smoothScrollTo(int x, int y, boolean withNestedScrolling) {
        smoothScrollTo(x, y, ExponentialBackoffSender.RND_MAX, withNestedScrolling);
    }
