        ...
        try {
            ...
            while (true) {
                ...
                if (i >= length) {
                    ...
                    return new Typeface.CustomFallbackBuilder(builder.build()).setStyle(new FontStyle((style & 1) != 0 ? LogSeverity.ALERT_VALUE : LogSeverity.WARNING_VALUE, (style & 2) != 0 ? 1 : 0)).build();
                }
